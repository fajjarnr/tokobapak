...
export const Route = createFileRoute('/new-arrivals/')({ component: Page })
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Produk Terbaru</h1>
          <p className="text-lg text-muted-foreground mb-8">Koleksi terbaru minggu ini dari brand favorit Anda.</p>

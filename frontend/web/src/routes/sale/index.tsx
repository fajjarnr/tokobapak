...
export const Route = createFileRoute('/sale/')({ component: Page })
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Sale & Promo</h1>
          <p className="text-lg text-muted-foreground mb-8">Diskon hingga 70% untuk kategori pilihan. Jangan lewatkan flash sale setiap hari!</p>

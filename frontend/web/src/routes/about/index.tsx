    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Tentang TokoBapak</h1>
          <p className="text-lg text-muted-foreground mb-8">Marketplace terpercaya sejak 2020, menghubungkan jutaan pembeli dan penjual di seluruh Indonesia dengan produk berkualitas dan harga terbaik.</p>

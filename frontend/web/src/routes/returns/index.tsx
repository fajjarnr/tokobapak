    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Pengembalian & Garansi</h1>
          <p className="text-lg text-muted-foreground mb-8">Garansi 7 hari tukar/kembalikan gratis jika produk tidak sesuai.</p>

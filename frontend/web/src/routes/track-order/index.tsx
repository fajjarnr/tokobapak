...
export const Route = createFileRoute('/track-order/')({ component: Page })
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Lacak Pesanan</h1>
          <p className="text-lg text-muted-foreground mb-8">Masukkan nomor resi untuk melacak status pengiriman pesanan Anda.</p>

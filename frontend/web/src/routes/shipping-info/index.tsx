...
export const Route = createFileRoute('/shipping-info/')({ component: Page })
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Info Pengiriman</h1>
          <p className="text-lg text-muted-foreground mb-8">Pengiriman gratis untuk pesanan di atas Rp100.000. Estimasi 1-3 hari kerja.</p>
